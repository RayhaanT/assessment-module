...
// Assessment Engine
$string['adaptivequestions'] = 'Enable adaptive questions';
$string['adaptivequestions_help'] = 'Questions generated by modules will adapt in difficulty based on how the student has performed so far in the quiz';
$string['addgeneratedmodule'] = "a new module";
...
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new quiz. <b>Settings for life cycle and module configuration can be found in the question bank.</b>';
