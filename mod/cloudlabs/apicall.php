	...
	if($USER->id) {
		...
		if(isset($data['MessageCode']) &&  $data['MessageCode']!=''){
			...
			if($mcode == 1003){
				...
				$message = '1028 : Please wait! Your lab will launch shortly!';
			} else if($mcode == 1029){
			...
			foreach($urldata as $uk=>$uval){
				...
				if($uval->key == 'WebConnect1RW'){
				    $monitorurl = $uval->value;
				}
				if($uval->key == 'WebConnect1RO'){
				    $monitorrourl = $uval->value;
				}
...
<div style="padding: 5px; border: 1px solid #ccc; border-radius: 3px; height: 350px; box-shadow: 0 0 20px rgba(0,0,0,.1);">
	...
	<div class="row">
	    <div class="col-md-12">
			<center> 		    
			<b>URL </b> :  <a href="<?php echo $url;?>" target="_blank"><?php echo $url;?></a>
			</center>
	...
	<?php if($monitorurl!=""){?>
	  <div class="row">
	    <div class="col-md-12">
			<center> 		    
			<b>Monitor URL </b> :  <a href="<?php echo $monitorurl;?>" target="_blank"><?php echo $monitorurl;?></a>
			</center>
	...
	<?php if($monitorrourl!=""){?>
	  <div class="row">
	    <div class="col-md-12">
			<center> 		    
			<b>Monitor RO URL </b> :  <a href="<?php echo $monitorrourl;?>" target="_blank"><?php echo $monitorrourl;?></a>
			</center>
	...
	<div class="row">
		<div class="col-md-12">
		<center>
		   <b>User Login</b> : <?php echo $loginuser_f;?>
		</center> 
		</div>
	</div>
	<div class="row">
		<div class="col-md-12">
		    <center> 
		    <b>User Password</b> : <?php echo $loginpassword_f;?>
			</center> 
		</div>
	</div>
