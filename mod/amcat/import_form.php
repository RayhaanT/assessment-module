 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class amcat_import_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('select', 'format', get_string('fileformat', 'amcat'), $this->_customdata['formats']);
    ...
    protected function validate_uploaded_file($data, $errors) {
        ...
        if (!is_readable($formatfile)) {
            throw new moodle_exception('formatnotfound', 'amcat', '', $data['format']);
        }
