...
define("amcat_PAGE_NUMERICAL",     "8");

class amcat_page_type_numerical extends amcat_page {

    protected $type = amcat_page::TYPE_QUESTION;
    protected $typeidstring = 'numerical';
    protected $typeid = amcat_PAGE_NUMERICAL;
    ...
    public function check_answer() {
        ...
        foreach ($answers as $answer) {
            ...
            if (($result->useranswer >= $minimum) && ($result->useranswer <= $maximum)) {
                ...
                if ($this->amcat->jumpto_is_correct($this->properties->id, $result->newpageid)) {
...
class amcat_add_page_form_numerical extends amcat_add_page_form_base {
...
class amcat_display_answer_form_numerical extends moodleform {
