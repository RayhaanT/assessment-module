@mod @mod_amcat
Feature: In a amcat activity, students can not re-attempt a question more than the allowed amount
  In order to check a amcat question can not be attempted more than the allowed amount
