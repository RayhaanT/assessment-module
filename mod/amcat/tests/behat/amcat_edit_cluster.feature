@mod @mod_amcat
Feature: In a amcat activity, teacher can edit a cluster page
  In order to modify an existing amcat and change navigation
  As a teacher
  I need to edit cluster pages in the amcat
  ...
  Scenario: Edit amcat cluster page
