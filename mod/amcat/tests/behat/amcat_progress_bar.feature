@mod @mod_amcat
Feature: In a amcat activity, students can see their progress viewing a progress bar.
  In order to create a amcat with conditional paths
  As a teacher
  ...
  Scenario: Student navigation with progress bar
    ...
    And I should see "You have completed 0% of the amcat"
    And I press "Next page"
    And I should see "Second page contents"
    And I should see "You have completed 33% of the amcat"
    And I press "Previous page"
    And I should see "First page contents"
    And I should see "You have completed 67% of the amcat"
    And I press "Next page"
    And I should see "Second page contents"
    And I should see "You have completed 67% of the amcat"
    And I press "Next page"
    ...
    And I should see "You have completed 100% of the amcat"
