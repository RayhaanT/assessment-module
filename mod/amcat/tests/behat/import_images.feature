@mod @mod_amcat
Feature: In a amcat activity, teacher can import embedded images in questions answers and responses
  As a teacher
  I need to import a question with images in answers and responses in a amcat

  @javascript @_file_upload
  Scenario: Import questions with images in answers and responses in a amcat
    ...
    And I upload "mod/amcat/tests/fixtures/multichoice.xml" file to "Upload" filemanager
    And I press "Import"
