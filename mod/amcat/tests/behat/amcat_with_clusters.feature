@mod @mod_amcat
Feature: In a amcat activity, students can see questions in random order
  In order to create a amcat with clusters
  As a teacher
  ...
  Scenario: amcat with two clusters
    ...
    When I follow "amcat with clusters"
