@mod @mod_amcat @_file_upload
Feature: In a amcat activity, teacher can add an essay question
  As a teacher
  I need to add an essay question in a amcat and grade student attempts
  ...
  Scenario: questions with essay question
    ...
    And I should see "Student 1"
    And I click on ".amcat-attempt-link" "css_element" in the "Student 1" "table_row"
