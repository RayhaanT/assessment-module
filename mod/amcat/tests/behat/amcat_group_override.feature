@mod @mod_amcat
Feature: amcat group override
  In order to grant a student special access to a amcat
  As a teacher
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | amcat   | Test amcat name | Test amcat description | 1          | C1     | amcat1  |
  ...
  Scenario: Allow a single group to have re-take the amcat
    Given I log in as "teacher1"
    And I am on "Course 1" course homepage with editing mode on
    When I follow "Test amcat name"
    ...
    And I follow "Test amcat name"
    Then I should not see "You are not allowed to retake this amcat."
    And I should see "Cat is an amphibian"
    And I log out
    ...
    And I should see "Congratulations - end of amcat reached"
    And I follow "Test amcat name"
    And I should see "You are not allowed to retake this amcat."
  ...
  Scenario: Allow a single group to have a different password
    ...
    And I set the following fields to these values:
      | Override group            | Group 1 |
      | Password protected amcat | 12345 |
    And I press "Save"
    And I should see "Password protected amcat"
    And I log out
    And I log in as "student1"
    And I am on "Course 1" course homepage
    And I follow "Test amcat name"
    Then I should see "Test amcat name is a password protected amcat"
    ...
    And I should see "Test amcat name is a password protected amcat"
  ...
  Scenario: Add both a user and group override and verify that both are applied correctly
    ...
    And I am on "Course 1" course homepage
    And I follow "Test amcat"
    And I should see "This amcat will be open on Friday, 1 January 2021, 8:00"
    And I log out
    And I log in as "student2"
    And I am on "Course 1" course homepage
    And I follow "Test amcat"
    And I should see "This amcat will be open on Tuesday, 1 January 2030, 8:00"
    And I log out
    And I log in as "student3"
    And I am on "Course 1" course homepage
    And I follow "Test amcat"
    And I should see "This amcat will be open on Wednesday, 1 January 2020, 8:00"
  ...
  Scenario: Override a group when teacher is in no group, and does not have accessallgroups permission, and the activity's group mode is 'separate groups'
    ...
    And the following "activities" exist:
      ...
      | amcat   | amcat 2 | amcat 2 description | C1     | amcat2  | 1         |
    When I log in as "teacher1"
    And I am on "Course 1" course homepage
    And I follow "amcat 2"
    And I navigate to "Group overrides" in current page administration
