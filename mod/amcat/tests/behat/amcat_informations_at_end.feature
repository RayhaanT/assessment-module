@mod @mod_amcat
Feature: In a amcat activity, if custom scoring is not enabled, student should see
  some informations at the end of amcat: questions answered, correct answers, grade, score

  Scenario: Informations at end of amcat if custom scoring not enabled
