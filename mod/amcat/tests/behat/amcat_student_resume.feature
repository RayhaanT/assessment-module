@mod @mod_amcat
Feature: In a amcat activity a student should
  be able to close the amcat and then later resume.
  ...
  Background:
    ...
    And I add a "amcat" to section "1"
  ...
  Scenario: resume a amcat with both content then question pages
    ...
    And I follow "Test amcat name"
    And I should see "You have seen more than one page of this amcat already."
    And I should see "Do you want to start at the last page you saw?"
    And I follow "Yes"
    Then I should see "Third page contents"
    # Add 1 sec delay so amcat knows differentiate 3rd and paper attempts.
    And I wait "1" seconds
    And I press "Next page"
  ...
  Scenario: resume a amcat with only content pages
    Given I follow "Add a content page"
    And I set the following fields to these values:
      | Page title | First page name |
      | Page contents | First page contents |
    ...
    And I should see "Third page contents"
    And I follow "Test amcat name"
    Then I should see "You have seen more than one page of this amcat already."
    And I should see "Do you want to start at the last page you saw?"
    And I follow "Yes"
    And I should see "Third page contents"
    And I press "Next page"
  ...
  Scenario: resume a amcat with both question then content pages
  ...
  Scenario: resume a amcat with only question pages
    Given I follow "Add a question page"
    And I set the field "Select a question type" to "True/false"
    And I press "Add a question page"
    And I set the following fields to these values:
