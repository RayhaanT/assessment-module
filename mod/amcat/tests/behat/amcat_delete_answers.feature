@mod @mod_amcat
Feature: In a amcat activity, teacher can delete question answers and
branch table contents
  In order to modify an existing amcat
  As a teacher
  I need to question answers and branch table contents in the amcat
  ...
  Scenario: Edit amcat content page
  ...
  Scenario: Edit amcat question page
