@mod @mod_amcat
Feature: In a amcat activity, teachers can review student attempts
  To review student attempts in a amcat
  As a Teacher
  ...
  Scenario: View student attempts in a amcat containing both content and question pages
