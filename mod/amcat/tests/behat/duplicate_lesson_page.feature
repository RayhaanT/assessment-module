@mod @mod_amcat
Feature: In a amcat activity, a teacher can duplicate a amcat page
  In order to duplicate a amcat page
  As a teacher
  I need to add content to a amcat
  ...
  Background:
    ...
    And I upload "mod/amcat/tests/fixtures/moodle_logo.jpg" file to "Files" filemanager
