@mod @mod_amcat
Feature: In a amcat activity, teacher can import blackboard fill in the blank question
  As a teacher
  I need to import a fill in the blank question made in Blackboard in a amcat

  @javascript @_file_upload
  Scenario: Import fill in the blank question in a amcat
    ...
    And I upload "mod/amcat/tests/fixtures/sample_blackboard_fib_qti.dat" file to "Upload" filemanager
    And I press "Import"
