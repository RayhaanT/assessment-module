@mod @mod_amcat
Feature: In a amcat activity, students can exit and re-enter the activity when it consists only of cluster pages
  As a student
  I need to exit and re-enter a amcat out and into clusters.
  ...
  Background:
    ...
    And I add a "amcat" to section "1" and I fill the form with:
      | Name | amcat with cluster |
      | Description | Cluster amcat description |
    And I follow "amcat with cluster"
  ...
  Scenario: Accessing as student to a cluster only amcat
