...
/**
 * This class contains the test cases for some of the functions in the amcat essay page type class.
 *
 * @copyright 2015 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU Public License
 */
class mod_amcat_essay_page_type_test extends advanced_testcase {
    public function test_amcat_essay_extract_useranswer() {
        ...
        $this->assertEquals($userresponse, amcat_page_type_essay::extract_useranswer($answer));
