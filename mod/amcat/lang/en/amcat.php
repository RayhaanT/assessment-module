...
/**
 * Strings for component 'amcat', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package mod_amcat
...
$string['activitylink_help'] = 'To provide a link at the end of the amcat to another activity in the course, select the activity from the drop-down menu.';
$string['activitylinkname'] = 'Go to {$a}';
$string['activityoverview'] = 'You have amcats that are due';
...
$string['allowofflineattempts'] = 'Allow amcat to be attempted offline using the mobile app';
$string['allowofflineattempts_help'] = 'If enabled, a mobile app user can download the amcat and attempt it offline.
All the possible answers and correct responses will be downloaded as well.
Note: It is not possible for a amcat to be attempted offline if it has a time limit.';
$string['and'] = 'AND';
...
$string['cannotfindnextpage'] = 'amcat backup: Next page not found!';
$string['cannotfindpagerecord'] = 'Add end of branch: page record not found';
$string['cannotfindpages'] = 'Could not find amcat pages';
...
$string['cannotfindrecords'] = 'Error: could not find amcat records';
$string['cannotfindtimer'] = 'Error: could not find amcat_timer records';
...
$string['closebeforeopen'] = 'Could not update the amcat. You have specified a close date before the open date.';
...
$string['completederror'] = 'Complete the amcat';
$string['completethefollowingconditions'] = 'You must complete the following condition(s) in <b>{$a}</b> amcat before you can proceed.';
$string['completionendreached'] = 'Require end reached';
$string['completionendreached_desc'] = 'Student must reach the end of amcat page to complete this activity';
...
$string['configintro'] = 'The values set here define the default values that are used in the settings form when creating a new amcat activity. Settings specified as advanced are only shown when the \'Show more...\' link is clicked.';
...
$string['configpassword_desc'] = 'Whether a password is required in order to access the amcat.';
...
$string['configtimelimit_desc'] = 'If a time limit is set, a warning is displayed at the beginning of the amcat and there is a countdown timer. If set to zero, then there is no time limit.';
$string['confirmdelete'] = 'Delete page';
$string['confirmdeletionofthispage'] = 'Confirm deletion of this page';
$string['congratulations'] = 'Congratulations - end of amcat reached';
...
$string['deleteallattempts'] = 'Delete all amcat attempts';
$string['deletedefaults'] = 'Deleted {$a} x amcat default';
...
$string['dependencyon_help'] = 'This setting allows access to this amcat to be dependent upon a student\'s performance in another amcat in the same course. Any combination of time spent, completed or "grade better than" may be used.';
...
$string['displayleftif_help'] = 'This setting determines whether a student must obtain a certain grade before viewing the amcat menu. This forces the student to go through the entire amcat on their first attempt, then after obtaining the required grade they can use the menu for review.';
...
$string['displayreview_help'] = 'If enabled, when a question is answered incorrectly, the student is given the option to try it again for no point credit, or continue with the amcat. If the student clicks to move on to another question then the selected (wrong) answer will be followed. By default wrong answer jumps are set to "this page" and have a score of 0, so it is recommended that you set the wrong answer jump to a different page to avoid confusion with your students.';
...
$string['editamcatsettings'] = 'Edit amcat settings';
...
$string['endofamcat'] = 'End of amcat';
...
$string['eolstudentoutoftime'] = 'Attention:  You ran out of time for this amcat.  Your last answer may not have counted if it was answered after the time was up.';
$string['eolstudentoutoftimenoanswers'] = 'You did not answer any questions.  You have received a 0 for this amcat.';
$string['essay'] = 'Essay';
$string['essayemailmessage2'] = '<p>Essay prompt: {$a->question}</p><p>Your response: <em>{$a->response}</em></p><p>Grader\'s comments: <em>{$a->comment}</em></p><p>You have received {$a->earned} out of {$a->outof} for this essay question.</p><p>Your grade for the {$a->amcat} amcat has been changed to {$a->newgrade}&#37;.</p>';
$string['essayemailmessagesmall'] = '<p>You have received {$a->earned} out of {$a->outof} for this essay question.</p><p>Your grade for the {$a->amcat} amcat has been changed to {$a->newgrade}&#37;.</p>';
$string['essayemailsubject'] = 'Grade available for amcat question';
...
$string['eventamcatended'] = 'amcat ended';
$string['eventamcatrestarted'] = 'amcat restarted';
$string['eventamcatresumed'] = 'amcat resumed';
$string['eventamcatstarted'] = 'amcat started';
$string['eventoverridecreated'] = 'amcat override created';
$string['eventoverridedeleted'] = 'amcat override deleted';
$string['eventoverrideupdated'] = 'amcat override updated';
...
$string['gotoendofamcat'] = 'Go to the end of the amcat';
$string['grade'] = 'Grade';
...
$string['handlingofretakes_help'] = 'If re-takes are allowed, this setting specifies whether the grade for the amcat is the mean or maximum of all attempts.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to view/attempt the amcat';
$string['insertedpage'] = 'Inserted page';
$string['indicator:cognitivedepth'] = 'amcat cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in a amcat activity.';
$string['indicator:cognitivedepthdef'] = 'amcat cognitive';
$string['indicator:cognitivedepthdef_help'] = 'The participant has reached this percentage of the cognitive engagement offered by the amcat activities during this analysis interval (Levels = No view, View, Submit, View feedback, Comment on feedback, Resubmit after viewing feedback)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'amcat social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in a amcat activity.';
$string['indicator:socialbreadthdef'] = 'amcat social';
$string['indicator:socialbreadthdef_help'] = 'The participant has reached this percentage of the social engagement offered by the amcat activities during this analysis interval (Levels = No participation, Participant alone, Participant with others)';
$string['indicator:socialbreadthdef_link'] = 'Learning_analytics_indicators#Social_breadth';
$string['invalidfile'] = 'Invalid file';
$string['invalidid'] = 'No course module ID or amcat ID were passed';
$string['invalidamcatid'] = 'amcat ID was incorrect';
$string['invalidoverrideid'] = 'Invalid override id';
$string['invalidpageid'] = 'Invalid page ID';
$string['jump'] = 'Jump';
$string['jumps'] = 'Jumps';
$string['jumps_help'] = 'Each answer (for questions) or description (for content pages) has a corresponding jump. The jump can be relative, such as this page or next page, or absolute, specifying any one of the pages in the amcat.';
$string['jumpsto'] = 'Jumps to <em>{$a}</em>';
$string['leftduringtimedsession'] = 'You have left during a timed amcat.';
$string['leftduringtimed'] = 'You have left during a timed amcat.<br />Please click on Continue to restart the amcat.';
$string['leftduringtimednoretake'] = 'You have left during a timed amcat and you are<br />not allowed to retake or continue the amcat.';
$string['amcat:addinstance'] = 'Add a new amcat';
$string['amcat:grade'] = 'Grade amcat essay questions';
$string['amcatclosed'] = 'This amcat closed on {$a}.';
$string['amcatcloses'] = 'amcat closes';
$string['amcateventcloses'] = '{$a} closes';
$string['amcat:edit'] = 'Edit a amcat activity';
$string['amcatformating'] = 'amcat formatting';
$string['amcat:manage'] = 'Manage a amcat activity';
$string['amcat:manageoverrides'] = 'Manage amcat overrides';
$string['amcat:view'] = 'View amcat activity';
$string['amcat:viewreports'] = 'View amcat reports';
$string['amcatmenu'] = 'amcat menu';
$string['amcatnotready'] = 'This amcat is not ready to be taken.  Please contact your {$a}.';
$string['amcatnotready2'] = 'This amcat is not ready to be taken.';
$string['amcatopen'] = 'This amcat will be open on {$a}.';
$string['amcatopens'] = 'amcat opens';
$string['amcateventopens'] = '{$a} opens';
$string['amcatpagelinkingbroken'] = 'First page not found.  amcat page linking must be broken.  Please contact an admin.';
$string['amcatstats'] = 'amcat statistics';
...
$string['maxgrade_help'] = 'This setting specifies the maximum grade for the amcat. If set to 0, the amcat does not appear in the grades pages.';
$string['maximumnumberofanswersbranches'] = 'Maximum number of answers';
$string['maximumnumberofanswersbranches_help'] = 'This setting specifies the maximum number of answers that may be used in the amcat. If only true/false questions are used, it can be set to 2. The setting may be changed at any time, since it only affects what the teacher sees, not the data.';
$string['maximumnumberofattempts'] = 'Maximum number of attempts';
$string['maximumnumberofattempts_help'] = 'This setting specifies the maximum number of attempts allowed for each question. If answered incorrectly repeatedly, when the maximum is reached, the next page of the amcat is displayed.';
...
$string['mediafile_help'] = 'A media file may be uploaded for use in the amcat. A \'Click here to view\' link will then be displayed in a block called \'Linked media\' on each page of the amcat.';
$string['mediafilepopup'] = 'Click here to view';
$string['mediaheight'] = 'Popup window height';
$string['mediawidth'] = 'Popup window width';
$string['messageprovider:graded_essay'] = 'amcat essay graded notification';
...
$string['modattempts_help'] = 'If enabled, students can navigate through the amcat again from the start.';
$string['modattemptsnoteacher'] = 'Student review only works for students.';
$string['modulename'] = 'amcat';
$string['modulename_help'] = 'The amcat activity module enables a teacher to deliver content and/or practice activities in  interesting and flexible ways. A teacher can use the amcat to create a linear set of content pages or instructional activities that offer a variety of paths or options for the learner. In either case, teachers can choose to increase engagement and ensure understanding by including a variety of questions, such as multiple choice, matching and short answer. Depending on the student\'s choice of answer and how the teacher develops the amcat, students may progress to the next page, be taken back to a previous page or redirected down a different path entirely.

A amcat may be graded, with the grade recorded in the gradebook.
...
$string['modulename_link'] = 'mod/amcat/view';
$string['modulenameplural'] = 'amcats';
...
$string['noessayquestionsfound'] = 'No essay questions found in this amcat.';
$string['nohighscores'] = 'No high scores';
$string['noamcatattempts'] = 'No attempts have been made on this amcat.';
$string['noamcatattemptsgroup'] = 'No attempts have been made by {$a} group members on this amcat.';
$string['none'] = 'None';
...
$string['nooverridedata'] = 'You must override at least one of the amcat settings.';
$string['noretake'] = 'You are not allowed to retake this amcat.';
$string['normal'] = 'Normal - follow amcat path';
$string['notcompleted'] = 'Not completed';
$string['notcompletedwithdate'] = 'Not completed ({$a})';
$string['notyetcompleted'] = 'amcat has been started, but not yet completed';
$string['notdefined'] = 'Not defined';
$string['notenoughsubquestions'] = 'Not enough sub-questions have been defined!';
$string['notenoughtimespent'] = 'You completed this amcat in {$a->timespent}, which is less than the required time of {$a->timerequired}. You might need to attempt the amcat again.';
...
$string['numberofpagestoshow_help'] = 'This setting specifies the number of pages shown in a amcat. It is only applicable for amcats with pages shown in a random order (when "Action after correct answer" is set to "Show an unseen page" or "Show an unanswered page"). If set to zero, then all pages are shown.';
...
$string['overridegroupeventname'] = '{$a->amcat} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->amcat} - Override';
$string['overview'] = 'Overview';
$string['overview_help'] = 'A amcat is made up of a number of pages and optionally content pages. A page contains some content and usually ends with a question. Associated with each answer to the question is a jump. The jump can be relative, such as this page or next page, or absolute, specifying any one of the pages in the amcat. A content page is a page containing a set of links to other pages in the amcat, for example a Table of Contents.';
$string['page'] = 'Page: {$a}';
$string['page-mod-amcat-x'] = 'Any amcat page';
$string['page-mod-amcat-view'] = 'View or preview amcat page';
$string['page-mod-amcat-edit'] = 'Edit amcat page';
...
$string['passwordprotectedamcat'] = '{$a} is a password protected amcat.';
...
$string['pluginadministration'] = 'amcat administration';
$string['pluginname'] = 'amcat';
...
$string['practice'] = 'Practice amcat';
$string['practice_help'] = 'A practice amcat does not appear in the gradebook.';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['prerequisiteisobsolete'] = 'The prerequisite amcat option is due to be removed. Please use access restrictions instead.';
$string['prerequisiteamcat'] = 'Prerequisite amcat';
$string['preview'] = 'Preview';
$string['previewamcat'] = 'Preview {$a}';
...
$string['privacy:metadata:grades'] = 'A record of the grades for each amcat';
...
$string['privacy:metadata:timer:amcattime'] = 'The last moment when we recorded activity';
...
$string['privacy:metadata:timer'] = 'A record of a amcat attempt';
...
$string['privacy:metadata:overrides:available'] = 'The time when the amcat may be attempted';
$string['privacy:metadata:overrides:deadline'] = 'The deadline for completing the amcat.';
$string['privacy:metadata:overrides:timelimit'] = 'Time limit to complete the amcat, in seconds.';
...
$string['privacy:metadata:overrides:password'] = 'The password to access the amcat';
$string['privacy:metadata:overrides'] = 'A record of overrides per amcat';
$string['privacy:metadata:userpref:amcatview'] = 'The preferred display mode when editing amcats';
...
$string['progressbar_help'] = 'If enabled, a bar is displayed at the bottom of amcat pages showing approximate percentage of completion.';
$string['progresscompleted'] = 'You have completed {$a}% of the amcat';
$string['progressbarteacherwarning'] = 'Progress bar does not display for {$a}';
$string['progressbarteacherwarning2'] = 'You will not see the progress bar because you can edit this amcat';
...
$string['retakesallowed_help'] = 'If enabled, students can attempt the amcat more than once.';
$string['returnto'] = 'Return to {$a}';
$string['returntocourse'] = 'Return to the course';
$string['reverttodefaults'] = 'Revert to amcat defaults';
$string['review'] = 'Review';
$string['reviewamcat'] = 'Review amcat';
...
$string['savechangesandeol'] = 'Save all changes and go to the end of the amcat.';
...
$string['search:activity'] = 'amcat - activity information';
...
$string['slideshow_help'] = 'If enabled, the amcat is displayed as a slideshow, with a fixed width and height.';
...
$string['startamcat'] = 'Start amcat';
$string['studentattemptamcat'] = '{$a->lastname}, {$a->firstname}\'s attempt number {$a->attempt}';
$string['studentname'] = '{$a} Name';
$string['studentoneminwarning'] = 'Warning: You have 1 minute or less to finish the amcat.';
$string['studentoutoftimeforreview'] = 'Attention: You ran out of time for reviewing this amcat';
$string['studentresponse'] = '{$a}\'s response';
$string['submit'] = 'Submit';
$string['submitname'] = 'Submit name';
$string['teacherjumpwarning'] = 'A {$a->cluster} jump or an {$a->unseen} jump is being used in this amcat.  The next page jump will be used instead. Log in as a student to test these jumps.';
...
$string['timelimit_help'] = 'If enabled, a warning about the time limit is displayed at the beginning of the amcat and a countdown timer is displayed. Any answers given after the time has elapsed are not graded.';
$string['timelimitwarning'] = 'You have {$a} to finish the amcat.';
$string['timeremaining'] = 'Time remaining';
$string['timespenterror'] = 'Spend at least {$a} minutes in the amcat';
...
$string['usepassword'] = 'Password protected amcat';
$string['usepassword_help'] = 'If enabled, a password is required in order to access the amcat.';
$string['useroverrides'] = 'User overrides';
$string['useroverridesdeleted'] = 'User overrides deleted';
$string['usersnone'] = 'No students have access to this amcat';
...
$string['youhaveseen'] = 'You have seen more than one page of this amcat already.<br />Do you want to start at the last page you saw?';
...
$string['additionalattemptsremaining'] = 'Completed, You can re-attempt this amcat';
$string['amcatcloseson'] = 'amcat closes on {$a}';
$string['amcatname'] = 'amcat: {$a}';
$string['xattempts'] = '{$a} attempts';


$string['testid'] = 'Test ID';
$string['startdatetime'] = 'Test Start date and time';