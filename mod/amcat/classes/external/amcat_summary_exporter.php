...
/**
 * Class for exporting partial amcat data.
 *
 * @package    mod_amcat
 * @copyright  2017 Juan Leyva <juan@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace mod_amcat\external;
...
/**
 * Class for exporting partial amcat data (some fields are only viewable by admins).
 *
 * @copyright  2017 Juan Leyva <juan@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class amcat_summary_exporter extends exporter {
    ...
    protected static function define_properties() {
        ...
        return array(
            ...
            'course' => array(
                'type' => PARAM_INT,
                'description' => 'Foreign key reference to the course this amcat is part of.'
            ),
            'coursemodule' => array(
                'type' => PARAM_INT,
            ...
            'name' => array(
                'type' => PARAM_RAW,
                'description' => 'amcat name.'
            ),
            'intro' => array(
                'type' => PARAM_RAW,
                'description' => 'amcat introduction text.',
                'optional' => true,
            ),
            'introformat' => array(
            ...
            'usepassword' => array(
                'type' => PARAM_BOOL,
                'description' => 'Password protected amcat?',
                'optional' => true,
            ),
            'password' => array(
                'type' => PARAM_RAW,
            ...
            'dependency' => array(
                'type' => PARAM_INT,
                'description' => 'Dependent on (another amcat id)',
                'optional' => true,
            ),
            'conditions' => array(
                'type' => PARAM_RAW,
                'description' => 'Conditions to enable the amcat',
                'optional' => true,
            ),
            'grade' => array(
                'type' => PARAM_INT,
            ...
            'activitylink' => array(
                'type' => PARAM_INT,
                'description' => 'Id of the next activity to be linked once the amcat is completed',
                'optional' => true,
            ),
            'mediafile' => array(
                'type' => PARAM_RAW,
            ...
            'slideshow' => array(
                'type' => PARAM_BOOL,
                'description' => 'Display amcat as slideshow',
                'optional' => true,
            ),
            'width' => array(
                'type' => PARAM_INT,
            ...
            'allowofflineattempts' => array(
                'type' => PARAM_BOOL,
                'description' => 'Whether to allow the amcat to be attempted offline in the mobile app',
            ),
        );
    }
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        if (isset($this->data->intro)) {
            $values['introfiles'] = external_util::get_area_files($context->id, 'mod_amcat', 'intro', false, false);
            $values['mediafiles'] = external_util::get_area_files($context->id, 'mod_amcat', 'mediafile', 0);
        }
