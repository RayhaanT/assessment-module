...
/**
 * The mod_amcat page_moved event class.
 *
 * @package    mod_amcat
 ...
 *     - int prevpageid: the id of the previous amcat page
 *     - int nextpageid: the id of the next amcat page
 * }
 *
 * @package    mod_amcat
 * @since      Moodle 2.9
...
class page_moved extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventpagemoved', 'mod_amcat');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' has moved a ".$this->other['pagetype']." page with the ".
                ...
                "' in the amcat activity with course module id '$this->contextinstanceid'.";
    }
    ...
    public static function get_other_mapping() {
        $othermapped = array();
        $othermapped['prevpageid'] = array('db' => 'amcat_pages', 'restore' => 'amcat_page');
        $othermapped['nextpageid'] = array('db' => 'amcat_pages', 'restore' => 'amcat_page');
