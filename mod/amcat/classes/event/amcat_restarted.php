...
/**
 * The mod_amcat amcat restarted event class.
 *
 * @package    mod_amcat
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */
class amcat_restarted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventamcatrestarted', 'mod_amcat');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' abandoned their previous incomplete attempt ".
               "and started a new attempt on the amcat with course module id '$this->contextinstanceid'.";
    }
