...
/**
 * The mod_amcat amcat resumed event class.
 *
 * @package    mod_amcat
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later.
 */
class amcat_resumed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventamcatresumed', 'mod_amcat');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' resumed their previous incomplete attempt on".
               " the amcat with course module id '$this->contextinstanceid'.";
    }
