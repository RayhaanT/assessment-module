...
define('BLOCK_MANAGER_SLIDER_CLASSNAME', 'block_manager_slider');
define('BLOCK_MANAGER_SLIDER_LANG', 'block_manager_slider');
define('BLOCK_MANAGER_SLIDER_BLOCKNAME', 'manager_slider');
define('BLOCK_MANAGER_SLIDER_DEFINITIONS', '/settings/definitions.php');
define('BLOCK_MANAGER_SLIDER_MILLISECONDS', 1000);
 ...
 * @return none
 */
function block_manager_slider_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    ...
    $fullpath = "/{$context->id}/block_manager_slider/$filearea/{$args[0]}/{$args[1]}";
