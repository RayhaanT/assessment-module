...
require_once($CFG->dirroot.'/blocks/manager_slider/lib.php');
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class block_manager_slider_edit_form extends block_edit_form {
    ...
    protected function specific_definition($mform) {
        ...
        $mform->addElement('header', 'general', get_string('generalconfiguration', BLOCK_MANAGER_SLIDER_LANG));

        // Title.
        $mform->addElement('text', 'config_title', get_string('title', BLOCK_MANAGER_SLIDER_LANG));
        $mform->setDefault('config_title', $defaultinstancesettings['title']);
        $mform->setType('config_title', PARAM_TEXT);

        // Cache time.
        $mform->addElement('duration', 'config_cachetime', get_string('cachetime', BLOCK_MANAGER_SLIDER_LANG));
        $mform->setDefault('config_cachetime', $defaultinstancesettings['cachetime']);
        $mform->setType('config_cachetime', PARAM_INT);

        // Courses.
        $mform->addElement('text', 'config_courses', get_string('courses', BLOCK_MANAGER_SLIDER_LANG));
        $mform->setDefault('config_courses', $defaultinstancesettings['courses']);
        $mform->setType('config_courses', PARAM_TEXT);
        $mform->addHelpButton('config_courses', 'courses', BLOCK_MANAGER_SLIDER_LANG);

        // Style Configuration.
        $mform->addElement('header', 'optionssection', get_string('styleconfiguration', BLOCK_MANAGER_SLIDER_LANG));

        // Border width.
        $mform->addElement('select', 'config_borderwidth', get_string('borderwidth', BLOCK_MANAGER_SLIDER_LANG), $from0to12px);
        $mform->setDefault('config_borderwidth', $defaultinstancesettings['borderwidth']);
        $mform->setType('config_borderwidth', PARAM_TEXT);

        // Border style.
        $mform->addElement('select', 'config_borderstyle', get_string('borderstyle', BLOCK_MANAGER_SLIDER_LANG), $borderstyles);
        $mform->setDefault('config_borderstyle', $defaultinstancesettings['borderstyle']);
        $mform->setType('config_borderstyle', PARAM_TEXT);

        // Border radius.
        $mform->addElement('select', 'config_borderradius', get_string('borderradius', BLOCK_MANAGER_SLIDER_LANG), $from0to12px);
        $mform->setDefault('config_borderradius', $defaultinstancesettings['borderradius']);
        $mform->setType('config_borderradius', PARAM_TEXT);

        // Image height.
        $mform->addElement('text', 'config_imagedivheight', get_string('imagedivheight', BLOCK_MANAGER_SLIDER_LANG));
        ...
        $mform->addElement('header', 'optionssection', get_string('navigationconfiguration', BLOCK_MANAGER_SLIDER_LANG));

        // Navigation Gallery.
        $mform->addElement('select', 'config_navigationgalleryflag',
                get_string('navigationgalleryflag', BLOCK_MANAGER_SLIDER_LANG), $onoff);
        ...
        $mform->addElement('select', 'config_navigationoptions',
                get_string('navigationoptions', BLOCK_MANAGER_SLIDER_LANG), $navigationoptions);
        ...
        $mform->addElement('text', 'config_navigationarrownext', get_string('navigationarrownext', BLOCK_MANAGER_SLIDER_LANG));
        $formhtmlnext = '<link href="'.$CFG->wwwroot.'/blocks/manager_slider/style/fontawesome-iconpicker.min.css"' .
                'rel="stylesheet" type="text/css">';
        $formhtmlnext .= '<script type="text/javascript" src="' .
                $CFG->wwwroot.'/blocks/manager_slider/jquery/fontawesome-iconpicker.min.js"></script>';
        ...
        // Number of slides.
        $mform->addElement('select', 'config_numberofslides', get_string('numberofslides', BLOCK_MANAGER_SLIDER_LANG), $from0to12);
        ...
        // Center mode.
        $mform->addElement('select', 'config_centermodeflag', get_string('centermodeflag', BLOCK_MANAGER_SLIDER_LANG), $onoff);
        ...
        $mform->addElement('header', 'optionssection', get_string('courseconfiguration', BLOCK_MANAGER_SLIDER_LANG));

        // Course Name.
        $mform->addElement('select', 'config_coursenameflag',
                get_string('coursenameflag', BLOCK_MANAGER_SLIDER_LANG), $hiddenvisible);
        ...
        // Course Summary.
        $mform->addElement('select', 'config_coursesummaryflag', get_string('coursesummaryflag', BLOCK_MANAGER_SLIDER_LANG),
                $hiddenvisible);
        ...
        $mform->addElement('header', 'optionssection', get_string('instancecsscustomisation', BLOCK_MANAGER_SLIDER_LANG));

        // Instance CSS ID.
        $mform->addElement('static', 'config_instancecssid', get_string('instancecssid', BLOCK_MANAGER_SLIDER_LANG));

        // Instance custom CSS.
        $mform->addElement('textarea', 'config_instancecustomcsstextarea',
                get_string('instancecustomcsstextarea', BLOCK_MANAGER_SLIDER_LANG));
