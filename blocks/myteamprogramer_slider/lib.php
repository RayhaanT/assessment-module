...
/**
 * Course slider block helper functions and callbacks
 *
...
define('BLOCK_MYTEAMPROGRAMER_SLIDER_CLASSNAME', 'block_myteamprogramer_slider');
define('BLOCK_MYTEAMPROGRAMER_SLIDER_LANG', 'block_myteamprogramer_slider');
define('BLOCK_MYTEAMPROGRAMER_SLIDER_BLOCKNAME', 'myteamprogramer_slider');
define('BLOCK_MYTEAMPROGRAMER_SLIDER_DEFINITIONS', '/settings/definitions.php');
define('BLOCK_MYTEAMPROGRAMER_SLIDER_MILLISECONDS', 1000);
 ...
 * @return none
 */
function block_myteamprogramer_slider_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options=array()) {
    ...
    $fullpath = "/{$context->id}/block_myteamprogramer_slider/$filearea/{$args[0]}/{$args[1]}";
