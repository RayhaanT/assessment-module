...
define(['jquery', 'core/ajax', 'core/notification'], function($, Ajax, Notification) {
     ...
     *
     * @method getmanagerprogress
     * @param {object} args The request arguments
     * @return {promise} Resolved with an array of courses
     */
    var getmanagerprogress = function(args) {

        var request = {
            methodname: 'block_managerprogress_get_starred_courses',
            args: args
        };
    ...
    return {
        getmanagerprogress: getmanagerprogress
    };
});