...
class block_intelliboard extends block_base {
    ...
    public function get_content() {
       ...
       // $courseid = 2;
        $courseid = isset($_GET['coursechart'])? $_GET['coursechart'] : 0;
        $canupdate = 0;
        if ($cmid) {
        ...
        $widgets .= html_writer::select($mycourselist, 'coursechart', $courseid, '',array('onchange' => 'this.form.submit(this.value)'));
