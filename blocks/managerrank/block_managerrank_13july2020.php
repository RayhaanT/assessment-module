...
class block_managerrank extends block_base {
    ...
    function get_content() {
		...
		$o.='<div class="row">
			...
			<div class="col-md-1"></div>
			<div class="col-md-10">
					<select name="coursmid" id="ccmrid" class="form-control" onchange="redir_mrank()">';
		$o.='<option value="">'.get_string('selectcours', 'block_managerrank').'</option>';		
		...
		window.onload = function() {
			...
			$.post("'.$CFG->wwwroot.'/blocks/ranking/reportm_glob.php", {"courseid": mid,"perpage":"5"}, function (jsondata) {
			$("#rrpm").html(jsondata);
			}, "json");
						}
			...
			$.post("'.$CFG->wwwroot.'/blocks/ranking/reportm_glob.php", {"courseid": mid,"perpage":"All"}, function (jsondata) {
			$("#rrpm").html(jsondata);
			}, "json");
						}
			</script>';
