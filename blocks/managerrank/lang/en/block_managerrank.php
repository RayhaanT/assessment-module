...
/**
 * Strings for component 'block_userdashbod', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   block_userdashbod
 * @copyright 1999 onwards Martin Dougiamas  {@link http://moodle.com}
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['adminview'] = 'Admin view';
$string['selectcours'] = 'Select Course';
$string['go'] = 'GO';
...
$string['userdashbod:addinstance'] = 'Add a new courses block';
$string['userdashbod:myaddinstance'] = 'Add a new courses block to Dashboard';
$string['hideallcourseslink'] = 'Hide \'All courses\' link';
$string['owncourses'] = 'Admin user sees own courses';
$string['pluginname'] = 'Manager rank';
