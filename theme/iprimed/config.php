...
$THEME->scss = function($theme) {
    ...
    return theme_iprimed_get_main_scss_content($parentconfig);
};

// Process extra scss to our final stylesheet.
$THEME->extrascsscallback = 'theme_iprimed_get_extra_scss';

// Process pre scss to our final stylesheet.
$THEME->prescsscallback = 'theme_iprimed_get_pre_scss';
