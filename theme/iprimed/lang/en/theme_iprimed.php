...
$string['pluginname'] = 'iprimed';
$string['configtitle'] = 'iprimed';
$string['choosereadme'] = 'iprimed is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
...
$string['privacy:metadata'] = 'The iprimed theme does not store any personal data about any user.';
...
$string['marketing5icon'] = 'Marketing5 Icon';
$string['marketing5icondesc'] = 'Upload Marketing5 Icon';
$string['marketing5heading'] = 'Marketing5 Heading';
$string['marketing5headingdesc'] = 'Enter Marketing5 Heading Text';
$string['marketing5subheading'] = 'Marketing5 Subheading';
$string['marketing5subheadingdesc'] = 'Enter Marketing5 Subheading Text';
$string['marketing5content'] = 'Marketing5 Content';
$string['marketing5contentdesc'] = 'Enter Marketing5 Content Text';
$string['marketing5url'] = 'Marketing5 URL';
$string['marketing5urldesc'] = 'Enter Marketing5 URL';
...
$string['footer1icon'] = 'Footer 1 icon';
$string['footer1icon_decs'] = 'Footer 1 icon decs';
$string['footer2icon'] = 'Footer 2 icon';
$string['footer2icon_decs'] = 'Footer 2 icon decs';
$string['footer3icon'] = 'Footer 3 icon'; 
$string['footer3icon_decs'] = 'Footer 3 icon decs';
$string['footer1lefticon'] = 'Footer 1 Left icon';
$string['footer1lefticon_decs'] = 'Footer 1 Left icon decs';


$string['footercolor_desc'] = 'If you not selected footer images then it will have another option to showin Footer color.';
