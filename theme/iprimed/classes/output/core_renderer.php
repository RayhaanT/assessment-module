...
namespace theme_iprimed\output;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function render_lang_menu() {
        ...
        if ($haslangmenu) {
            ...
            if (isset($context)) {
                return $this->render_from_template('theme_iprimed/lang_menu', $context);
            }
        }
    }
    ...
    public function get_pix_image_url_base() {
        ...
        return $CFG->wwwroot . "/theme/iprimed/pix";
    }
    ...
    public function render_help_icon(help_icon $helpicon) {
        ...
        // Check issue https://github.com/willianmano/moodle-theme_iprimed/issues/5.
    ...
    public function search_box($identifier = false) {
        ...
        return html_writer::tag('div',
                                $searchinput,
                                array('class' => 'iprimed-search-input nav-link', 'id' => $identifier));
    }
    ...
    public function headerbutton() {
        ...
        $inputattrs = array('type' => 'a', 'name' => 'q', 'href' => '#', 'id' => 'loginbutt',  'class' => 'loginbut float-right');
       return html_writer::tag('a', 'Log in', $inputattrs, array('class' => 'loginbut1'));

    }

    public function headerbutton_course() {
        $inputattrs = array('type' => 'a', 'name' => 'q', 'href' => '#', 'class' => 'loginbut  float-right');

       return  html_writer::tag('a', 'Courses', $inputattrs, array('class' => 'loginbut1'));
    ...
    public function breadcrumb_header() {
        ...
        if ($PAGE->pagelayout == 'mypublic') {
            $header->contextheader = "<h2>". get_string('userprofile', 'theme_iprimed') ."</h2>";
        }

        return $this->render_from_template('theme_iprimed/breadcrumb', $header);
    }
}
