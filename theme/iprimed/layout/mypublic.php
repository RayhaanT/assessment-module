...
$templatecontext = array_merge($templatecontext, $themesettings->footer_items(),  $themesettings->footericon(), $themesettings->footerlefticon());

$usercourses = \theme_iprimed\util\extras::user_courses_with_progress($user);
...
$templatecontext['user']->profilepicture = \theme_iprimed\util\extras::get_user_picture($user, 100);

$competencyplans = \theme_iprimed\util\extras::get_user_competency_plans($user);
$templatecontext['hascompetencyplans'] = (count($competencyplans)) ? true : false;
$templatecontext['competencyplans'] = $competencyplans;

$templatecontext['headerbuttons'] = \theme_iprimed\util\extras::get_mypublic_headerbuttons($context, $user);

echo $OUTPUT->render_from_template('theme_iprimed/mypublic', $templatecontext);