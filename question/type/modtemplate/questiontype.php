...
/**
 * The template question type.
 *
 * This questions type pulls random questions out of the question
 * bank upon page load based on given topic and difficulty settings.
 * It function similarly to the random qtype. 
 */
class qtype_modtemplate extends question_type {
