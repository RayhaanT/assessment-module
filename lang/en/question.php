...
$string['subtopic'] = 'Sub-topic';
$string['boundary'] = 'Boundary';
$string['boundary_help'] = 'You can divide a topic/sub-topic into multiple boundary levels. When a student is tested, they will have to correctly answer a progression of questions within that boundary to clear it and move on.';
$string['addroles'] = 'Blanks for {no} more roles';
$string['addsubjects'] = 'Blanks for {no} more subjects';
$string['addregions'] = 'Blanks for {no} more regions';
$string['roleno'] = 'Role {$a} name';
$string['subjectno'] = 'Subject {$a}';
$string['regionno'] = 'Region {$a}';
...
$string['difficultylifecycle'] = 'Retirement settings and renaming for difficulty levels';
